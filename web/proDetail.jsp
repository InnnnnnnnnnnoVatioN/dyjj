...
                            List<String> descs = g.fromJson(goods.getGdesc(), List.class);
...
                    <div class="num clearfix"><img class="fl sub" src="img/temp/sub.jpg"><span class="fl number"
...
                             * $.post("addCart.do","goodsId=11",function(data){

                            });
                             *
                             *
                             */
                            //{status:200,msg:"购物车加入成功"}
                            $.get("addCart.do","goodsId=<%=goods.getId()%>",function(data){
