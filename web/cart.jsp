...
<%@ page import="com.dy.service.SqlCartsService" %><%--
...
        gs = GoodsService.findGoodsByCarts(cs);
...
            href="index.jsp" class="fr">继续购物&gt;</a></p></div>
    <!-----------------table------------------->

    <div class="table wrapper">
        <%
            if(cs == null || cs.size() == 0 || gs == null || gs.size() == 0){
...
                    <dt class="fl"><img src="<%=img%>" style="width:120px;height:120px">  <%--style="width:120px;height:120px" src="<%=img%>">--%></dt>
...
                <img class="fl add" onclick="cartNumUpdate(1,<%=goods.getId()%>,this)" src="img/temp/add.jpg">
...
            <p class="fr"><span>共<small id="sl"><%=cs.size()%></small>件商品</span><span>合计:&nbsp;<small id="all">￥<%=priceAll%></small></span><a
...
    <p class="clearfix"><a class="fl cer" href="javascript:myDel2();">确定</a><a class="fr cancel" href="#">取消</a></p></div><!--返回顶部-->
...
        $.get("cartDel.do","goodsId="+goodsId,function(){});
...
        /*console.log("goodsId="+goodsId+"&isCheck="+(input.checked?0:1))*/
